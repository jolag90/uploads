defmodule Upload17Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Upload17Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Upload17Web.Gettext, "errors", msg, opts)
    end
  end
